...
{
    public Text text;
    private  enum States {bottom, horse, helicopter, person, helipad, pond, forest, location};
    ...
    void State_bottom()
    {
        ...
        text.text = "You are at the bottom of a mountain and you want to climb it. " +
                        ...
                        "Press M to ride the horse, H to enter in the helicopter and P for asking a person";
    ...
    void State_helicopter()
    {
        ...
        text.text = "Good choice! Pilot is skilled in flying in the moutains. " +
                    ...
                    "Press D for Pond, F for Forest, A to land on Helipad";
